...
resA = run_nonlinear_test( ...
    mpcobj, sys, p, options, L, idxMV, idxMD, ...
    mu_u, sigma_u, mu_y, sigma_y, mv_bounds_norm, ...
    x0, u0, x_hat_warm, r_sp_traj, [], Ts);
...
resS4 = run_nonlinear_test( ...
    mpcobj, sys, p, options, L, idxMV, idxMD, ...
    mu_u, sigma_u, mu_y, sigma_y, mv_bounds_norm, ...
    x0, u0, x_hat_warm, r_S4_traj, d_S4_phys, Ts);
...
resS6 = run_nonlinear_test( ...
    mpcS6, sys, p, options, L, idxMV, idxMD, ...
    mu_u, sigma_u, mu_y, sigma_y, mv_bounds_norm, ...
    x0, u0, x_hat_warm, r_S6_traj, [], Ts);
